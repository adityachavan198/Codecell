...
class team(models.Model):
    ...
    mate2_name = models.CharField(verbose_name = "Team Leader name", max_length= 50, blank= True)
    mate2_number = models.CharField(validators=[phone_regex], max_length=15, blank=True)
    mate2_email = models.EmailField(blank=True)

    mate3_name = models.CharField(verbose_name="Team Leader name", max_length=50, blank=True)
    mate3_number = models.CharField(validators=[phone_regex], max_length=15, blank=True)
    mate3_email = models.EmailField(blank=True)

    mate4_name = models.CharField(verbose_name="Team Leader name", max_length=50, blank=True)
    ...
    problem2_selected = models.ForeignKey(problems, related_name='ps2',verbose_name= 'Selected problem statement 1',  on_delete=models.CASCADE, blank=False)
    solution2 = models.CharField(verbose_name="Solution", help_text="How will you solve it", max_length=500, blank=False)

    problem3_selected = models.ForeignKey(problems,  related_name='ps3',verbose_name= 'Selected problem statement 1', on_delete=models.CASCADE, blank=False)
    solution3 = models.CharField(verbose_name="Solution", help_text="How will you solve it", max_length=500, blank=False)
    def __str__(self):
        return self.name